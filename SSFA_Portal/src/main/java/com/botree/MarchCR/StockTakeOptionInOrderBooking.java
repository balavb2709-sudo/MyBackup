...
public class StockTakeOptionInOrderBooking extends BaseTest_Listener {
	...
	public StockTakeOptionInOrderBooking(AppiumDriver appiumDriver) {
		this.mobileDriver = appiumDriver;
		PageFactory.initElements(appiumDriver, this);

	}

	public StockTakeOptionInOrderBooking(WebDriver webDriver) {
